...
const PAGES: Cmd[] = [
  ...
  { key: 'p-fil-stock', group: 'Ir a', label: 'Stock del mes (filamento)', to: '/filament/stock', icon: Box },
  { key: 'p-fil-buy', group: 'Ir a', label: 'Compras de filamento', to: '/filament/compras', icon: Receipt },
